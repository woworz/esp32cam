...
本项目是一个基于 **ESP32-S3 + OV2640** 的无线图传系统，支持:
- MJPEG 实时视频流
- 按键/HTTP 触发拍照
- 照片上传到远程服务器
- 服务器端自动叠加文字时间戳
...
### ESP32-S3-DevKitC-1 <-> OV2640 引脚映射

| 功能     | OV2640引脚 | ESP32-S3 GPIO | 说明                    |
|----------|-----------|---------------|------------------------|
...
| 时钟输出 | XCLK      | GPIO15        | ESP32为OV2640提供时钟   |
